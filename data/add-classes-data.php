						...
						if (mysqli_query($con, $sql)) {
							...
							if (mysqli_query($con, $sql5)) {
								...
								if(mysqli_num_rows($result10) == 1) {
									...
									$sql11 = "SELECT * FROM teacher_class_tbl WHERE grade_class_id='$grade_class_id' AND year='$year' AND teacher_id='$class_teacher_id'";
									$result11 = mysqli_query($con, $sql11);
									if(mysqli_num_rows($result11) < 1) {
										$sql12 = "INSERT INTO teacher_class_tbl(teacher_id, grade_class_id, year) VALUES ('$class_teacher_id', '$grade_class_id', '$year')";
