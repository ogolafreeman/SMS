<?php
session_start();
if (isset($_SESSION['username']) && isset($_SESSION['secHead_role'])) {
...
?>
    ...
    <head>
        ...
        <title>Section Head's Profile - Section Head</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container-fluid">
                <h1 class="mt-4">Section Head's Profile</h1>
                ...
                <div class="container mt-3">
                    <!-- <a class='btn btn-primary' href='view-all-teachers.php'>Dashboard</a> -->
