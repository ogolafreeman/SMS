                            ...
                            <div class="row">
                                <div class="col-md-3 border-right">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        } ?>" class="rounded-circle mt-5" width="250px" alt="profile picture"
                                            height="250px">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="fname" class="form-control" autocomplete="off"
                                                    readonly required value="<?php if (!isset($_GET['error']) && !empty($teacher['first_name'])) {
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="lname" class="form-control" autocomplete="off"
                                                    readonly value="<?php if (!isset($_GET['error']) && !empty($teacher['last_name'])) {
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="nic" class="form-control" autocomplete="off"
                                                    readonly required value="<?php if (!isset($_GET['error']) && !empty($teacher['nic'])) {
                                                        echo $teacher['nic'];
                                                    } else {
                                                        echo "";
                                                    } ?>">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <input type="date" name="dob" class="form-control" autocomplete="off"
                                                    readonly required value="<?php if (!isset($_GET['error']) && !empty($teacher['dob'])) {
                                                        echo $teacher['dob'];
                                                    } else {
                                                        echo "";
                                                    } ?>">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <input type="email" name="email" class="form-control" autocomplete="off"
                                                    readonly required value="<?php if (!isset($_GET['error']) && !empty($teacher['email'])) {
                                                        echo $teacher['email'];
                                                    } else {
                                                        echo "";
                                                    } ?>">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <textarea class="form-control" id="floatingTextarea2" readonly
                                                    style="height: 100px" name='qualifications'><?php if (!isset($_GET['error']) && !empty($teacher['qualifications'])) {
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="t_no" class="form-control" readonly autocomplete="off"
                                                required value="<?php if (!isset($_GET['error']) && !empty($teacher['staff_no'])) {
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="date" name="app_date" class="form-control" readonly
                                                autocomplete="off" required value="<?php if (!isset($_GET['error']) && !empty($teacher['app_date'])) {
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="date" name="rc_app_date" class="form-control" readonly
                                                autocomplete="off" required value="<?php if (!isset($_GET['error']) && !empty($teacher['rc_app_date'])) {
