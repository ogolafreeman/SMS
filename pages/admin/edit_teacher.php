                    ...
                    <form action="../../data/update-teacher-data.php?id=<?= $teacher['staff_id'] ?>" method="post" class="shadow p-3  mt-3 form-w">
                        ...
                        <div class="container rounded bg-white mt-5 mb-5">
                            <div class="row">
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="lname" class="form-control" autocomplete="off" value="<?php if (!isset($_GET['error']) && !empty($teacher['last_name'])) {
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <textarea class="form-control" id="floatingTextarea2" style="height: 100px" name='qualifications'><?php if (!isset($_GET['error']) && !empty($teacher['qualifications'])) {
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="t_no" class="form-control" autocomplete="off" required value="<?php if (!isset($_GET['error']) && !empty($teacher['staff_no'])) {
                                ...
                                <div class="mt-5 text-center"><button class="btn btn-warning profile-button" type="submit" name='update'>Save Profile</button></div>
                            </div>
                        </div>
                        <!-- </div>
            </div> -->
