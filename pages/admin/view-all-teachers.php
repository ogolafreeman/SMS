                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" name="profile"
                                            href="view-teacher-info.php?id=<?= $teacher[0] ?>">Profile</a>
                                        <a class="btn btn-warning" name="edit"
                                            href="edit_teacher.php?id=<?= $teacher[0] ?>">Edit</a>
                                        <a class="btn btn-danger" name="delete"
                                            href="delete_teacher.php?id=<?= $teacher[0] ?>">Delete</a>
                                    </td>
                                </tr>
